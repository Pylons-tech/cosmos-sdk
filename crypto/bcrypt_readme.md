...
```bash
go test -v --bench github.com/Pylons-tech/cosmos-sdk/crypto/keys/mintkey
```
...
goos: linux
goarch: amd64
pkg: github.com/Pylons-tech/cosmos-sdk/crypto/keys/mintkey
...
PASS
ok  	github.com/Pylons-tech/cosmos-sdk/crypto/keys/mintkey	12.093s
```
