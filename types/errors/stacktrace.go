...
func trimInternal(st errors.StackTrace) errors.StackTrace {
	...
	for matchesFunc(st[0],
		...
		"github.com/Pylons-tech/cosmos-sdk/types/errors.Wrap",
		"github.com/Pylons-tech/cosmos-sdk/types/errors.Wrapf",
		"github.com/Pylons-tech/cosmos-sdk/types/errors.WithType",
